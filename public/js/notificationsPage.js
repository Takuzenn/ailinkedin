...
function createNotificationHtml(notification) {
    ...
    var text = gotNotificationText(notification);
    var href = gotNotificationUrl(notification);
...
function gotNotificationText(notification) {
...
function gotNotificationUrl(notification) {

    var url = "#";


    if (notification.notificationType == "retweet"  || notification.notificationType == "postLike"
